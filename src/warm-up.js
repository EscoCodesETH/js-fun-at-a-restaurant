...
vegetables = ['spinach', 'brussel', 'lettecue', 'carrots', 'broc']
...
// different fruits.
fruits = ['strawberry', 'kiwi', 'apple', 'orange', 'mango']
...
groceryStrore.location = 'Denver Colorado'
console.log(groceryStrore)